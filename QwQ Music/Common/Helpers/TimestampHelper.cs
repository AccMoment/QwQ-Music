...
public static class TimestampHelper {
    ...
    ///     获取当前时间戳（秒）
    /// </summary>
    public static long GetTimestamp() { return DateTimeOffset.UtcNow.ToUnixTimeSeconds(); }

    /// <summary>
    ///     获取当前时间戳（毫秒）
    /// </summary>
    public static long GetTimestampMs() { return DateTimeOffset.UtcNow.ToUnixTimeMilliseconds(); }
    ...
    ///     时间戳转DateTime（秒）
    /// </summary>
    public static DateTime ToDateTime(long timestamp) { return DateTimeOffset.FromUnixTimeSeconds(timestamp).DateTime; }
    ...
    /// </summary>
    public static DateTime FromUnixTimestamp(long timestamp) { return _unixEpoch.AddSeconds(timestamp).ToLocalTime(); }
    ...
    /// </summary>
    public static DateTime FromUnixTimestampUtc(long timestamp) { return _unixEpoch.AddSeconds(timestamp); }
