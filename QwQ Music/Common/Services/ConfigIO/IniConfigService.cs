...
public class IniConfigService {
    ...
    public IniConfigService(string? filePath) { Load(filePath); }
    ...
    public void Load(string? filePath) {
        ...
        try {
            ...
            foreach (string line in File.ReadAllLines(filePath, Encoding.UTF8)) {
                ...
                if (!_data.TryGetValue(section, out Dictionary<string, string>? dict)) {
    ...
    public bool ContainsKey(string key, string? section = "") {
        ...
        try {
            ...
            return _data.TryGetValue(section, out Dictionary<string, string>? dict) && dict.ContainsKey(key);
        } finally {
            _lock.ExitReadLock();
        }
    }
