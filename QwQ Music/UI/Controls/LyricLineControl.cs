...
public class LyricLineControl : TemplatedControl {
    ...
    public static readonly StyledProperty<string?> TranslationProperty =
        AvaloniaProperty.Register<LyricLineControl, string?>(nameof(Translation));

    // 是否显示翻译
    public static readonly StyledProperty<bool> ShowTranslationProperty =
        AvaloniaProperty.Register<LyricLineControl, bool>(nameof(ShowTranslation));
    ...
    public static readonly StyledProperty<double> PrimaryFontSizeProperty =
        AvaloniaProperty.Register<LyricLineControl, double>(nameof(PrimaryFontSize), 2.0);

    // 翻译大小
    public static readonly StyledProperty<double> TranslationFontSizeProperty =
        AvaloniaProperty.Register<LyricLineControl, double>(nameof(TranslationFontSize), 2.0);

    // 翻译间距
    public static readonly StyledProperty<double> TranslationSpacingProperty =
        AvaloniaProperty.Register<LyricLineControl, double>(nameof(TranslationSpacing), 2.0);

    // 歌词文本边距
    public static readonly StyledProperty<Thickness> TextMarginProperty =
        AvaloniaProperty.Register<LyricLineControl, Thickness>(nameof(TextMargin), new Thickness(10, 0, 10, 0));
