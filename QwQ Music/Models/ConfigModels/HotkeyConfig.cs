...
public class SerializableKeyGesture(Key key, KeyModifiers modifiers = KeyModifiers.None) {
    public SerializableKeyGesture() : this(Key.None) { }
    ...
    ///     转换为KeyGesture
    /// </summary>
    public KeyGesture ToKeyGesture() { return new KeyGesture(Key, KeyModifiers); }
    ...
    ///     隐式转换操作符
    /// </summary>
    public static implicit operator SerializableKeyGesture(KeyGesture gesture) { return FromKeyGesture(gesture); }
}
